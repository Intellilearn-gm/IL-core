...
export default function ArcheryProPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E5E1D8] to-[#FFE8D6]">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-[#2E2B2B]">Archery Pro</h1>
            </div>
          </div>
      ...
      <main className="w-full flex-1 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-[#2E2B2B] mb-4">Archery Pro</h2>
          <p className="text-[#7D7A75] mb-6">
            Learn blockchain fundamentals while adjusting angle and power to shoot arrows at enemy targets. 
            Each level comes with a blockchain-related quiz, ensuring learning through action.
          </p>
