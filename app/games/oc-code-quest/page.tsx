...
import { ArrowLeft, X, Code } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E5E1D8] to-[#FFE8D6]">
      ...
      <main className="w-full flex-1 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-2xl font-bold text-[#2E2B2B] mb-4">OC Code Quest</h2>
          <p className="text-[#7D7A75] mb-6">
            Navigate a spaceship and collect tokens. Learn how OCID works and why decentralized identity matters. 
            Players avoid obstacles while unlocking OCID-based concepts.
          </p>
